...
$realistic_slides
  ...
  <script>
    Reveal.initialize({
      // Schermi del palco in verticale (9:16 portrait). Reveal scala
      // automaticamente il canvas su qualsiasi display mantenendo il rapporto:
      // - schermo verticale grande (palco): riempie tutto
      // - desktop landscape: scala in altezza con bande cream ai lati
      // - tablet/smartphone: riempie tutto in portrait, scala in landscape
      width: 1080,
      height: 1920,
      margin: 0.02,
      minScale: 0.1,
