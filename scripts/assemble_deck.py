...
REALISTIC_SLIDES = [
    # =============== INTRO: chi siamo, perchè, il problema ===============
    {
        ...
        "big": "ANNO ZERO",
        "caption": "L'AI entra nel lavoro adesso. Siamo in tempo per esserne pionieri.",
        "cue": "Tono diretto, voce piena. Pausa dopo 'pionieri'.",
        "bullets": [
            "L'AI nel mondo del lavoro inizia oggi, non domani.",
            "Chi la integra adesso costruisce un vantaggio vero.",
    ...
    },
    {
        ...
        "big": "CHI",
        "caption": "Strumenti AI costruiti per il lavoro italiano.",
        "cue": "Indica il logo. 'Costruita per voi.'",
        "bullets": [
            "Cinque piattaforme. Una visione: dare al consulente più tempo.",
            "Per chi tiene insieme studi, aziende e dipendenti.",
    ...
    },
    {
        ...
        "big": "TEMPO",
        "caption": "Ogni ora dietro a una circolare è un'ora tolta al cliente.",
        ...
        "bullets": [
            ...
            "Tempo tolto al cliente, alla relazione, al mestiere vero.",
            "L'AI non vi sostituisce. Vi restituisce le ore.",
        ],
    },
    ...
    # =============== 5 PIATTAFORME (presentate come 5 progetti per la nuova era) ===============
    {
        "id": "16", "title": "CRM-DVR",
        "big": "DVR",
        "caption": "Il vostro assistente per la sicurezza sul lavoro.",
        "cue": "Frase forte: 'Da 30 ore a 4 ore. Per ogni documento.'",
        "bullets": [
            "Il Documento di Valutazione dei Rischi, completo e a norma di legge.",
            "Da 15 o 30 ore di lavoro a 2 o 4 ore. L'85 per cento del tempo torna a voi.",
            "Carica tutto in una volta sola. L'AI controlla, valida, cita la norma.",
            "Doppia firma del consulente e del titolare. Ogni passaggio resta tracciato.",
        ],
    },
    {
        "id": "17", "title": "Project Manager con FALCO AI",
        "big": "PARLA",
        "caption": "Smettete di rincorrere il gestionale. Parlate. FALCO esegue.",
        "cue": "Alza energia. 'L'AI esegue, non si limita a suggerire.'",
        "bullets": [
            "L'AI non solo consiglia. Crea progetti, attività e riunioni davvero.",
            "Comandate con la voce, in italiano. 'FALCO, crea il progetto.'",
            "Videoconferenze integrate, con trascrizione e riepilogo automatico.",
            "Tra una e una ora e mezza al giorno, restituite a chi guida l'azienda.",
        ],
    },
    {
        "id": "18", "title": "Preventivatore AI",
        "big": "AUTO",
        "caption": "Dal primo contatto al contratto firmato, senza interventi manuali.",
        ...
        "bullets": [
            ...
            "Applica il vostro listino, sceglie i servizi, prepara il documento.",
            "Quando il cliente dice sì, il preventivo diventa contratto da firmare.",
            "Firma digitale integrata. Un solo flusso, dall'idea alla firma.",
        ],
    },
    {
        "id": "19", "title": "VCS, la formazione che vale",
        "big": "AULA",
        "caption": "Formazione sulla sicurezza, legalmente valida, guidata dall'AI.",
        "cue": "Voce ferma. 'La conformità non si spunta. Si garantisce.'",
        "bullets": [
            "A norma con Accordo Stato Regioni 2025 e Decreto Sicurezza 81.",
            "Il sistema impedisce di proposito qualunque configurazione fuori legge.",
            "Un assistente AI ascolta in aula e suggerisce al docente in tempo reale.",
            "Quiz protetti contro le frodi. Attestato con QR di verifica pubblica.",
        ],
    },
    {
        "id": "20", "title": "Lead Search",
        "big": "CLIENTI",
        "caption": "I prossimi clienti sono già là fuori. Lead Search li trova per voi.",
        ...
        "bullets": [
            ...
            "Esporta dove volete: nei vostri sistemi clienti, in Excel, in CSV.",
        ],
    },
    ...
    # =============== SINTESI + METODO + CHIUSURA ===============
    {
        ...
        "big": "5",
        "caption": "Per ogni snodo del vostro lavoro, uno strumento dedicato.",
        "cue": "Voce piena. 'Specifici. Italiani. Pensati per voi.'",
        "bullets": [
            "Ogni passaggio chiave ha il suo strumento AI dedicato.",
            "Strumenti specifici, costruiti da chi conosce il mestiere.",
    ...
    },
    {
        ...
        "big": "BMAD",
        "caption": "Un metodo semplice: una mossa alla volta, provata e confermata.",
        "cue": "Calma. 'Niente effetti speciali. Niente promesse vuote.'",
        "bullets": [
            "Costruire, misurare, aggiustare, mettere in funzione.",
            "Una modifica alla volta, provata insieme al cliente.",
    ...
    },
    {
        ...
        "big": "ADESSO",
        "caption": "Altri aspetteranno. Voi avete già lo strumento in mano.",
        "cue": "Voce calda. Pausa 3s prima di 'Grazie'.",
        "bullets": [
            "Anno zero. Adesso. Per chi conosce il mestiere.",
            "Cinque progetti pronti. Una visione condivisa.",
            "L'AI non vi sostituisce. Vi rende protagonisti.",
            "Entriamo insieme nella nuova era.",
        ],
    },
]
